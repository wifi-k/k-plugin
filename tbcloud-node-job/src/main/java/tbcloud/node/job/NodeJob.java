 ...
 */
@Injector
public abstract class NodeJob extends AbstractJob {

    protected static Logger LOG = LoggerFactory.getLogger(NodeJob.class);

    NodeJobPlugin plugin;
    ...
    protected NodeJobPlugin plugin() {
        return plugin;
    }
